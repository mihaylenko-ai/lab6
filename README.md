...
В качестве исходной сети, возьмем сеть из лабораторной работы №5 с уже настроенным Underlay и Overlay на основе eBGP. В качестве модели возьмем симметричную маршрутизацию. 
